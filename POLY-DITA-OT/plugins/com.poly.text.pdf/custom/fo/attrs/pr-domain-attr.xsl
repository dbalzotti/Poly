...
<!--
	2.4.3 DITA-OT plugin
	**** Modified by DBissantz 01/2/2020 - 
	Importing changes from 3.2 DITA-OT plugin.
-->
...
<!-- Modified DBissantz	01/02/2020
	Added use-attribute-sets="pt__content" to parmname.
	Added space-before set to 1.5pc and space-after set to 1.5pc to plentry.
	Added font-family set to monospace and font-size set to 12pt to pt__content.
	Changed start-indent from 72pt to 18pt.
	Modified DBissantz 12/13/2019
	Removed use-attribute-sets on parmname.
	Added font-family set to monospace, and font-size set to 11pt to parmname.
	Added keep-with-next.within-page set to always on pt.
-->
