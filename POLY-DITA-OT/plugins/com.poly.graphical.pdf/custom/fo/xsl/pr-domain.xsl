...
<!--
	...
	**** Modified by DBissantz 01/02/2020 - 
...
<!--
 	**** Modified by DBissantz 01/02/2020 - 
	Removed font-weight from fo:inline.
-->	
    <xsl:template match="*[contains(@class,' pr-d/parmname ')]">
	<xsl:choose>
	<xsl:when test="ancestor::*[contains(@class,' pr-d/parml ')]">
    ...
    <xsl:template match="*[contains(@class,' pr-d/parml ')]" priority="5">
        <xsl:call-template name="generateAttrLabel"/>
    ...
    <xsl:template match="*[contains(@class,' pr-d/plentry ')]" priority="5">
    ...
    <xsl:template match="*[contains(@class,' pr-d/pt ')]" priority="5">
    ...
    <xsl:template match="*[contains(@class,' pr-d/pd ')]" priority="5">
