...
--> 
    ...
    <xsl:template name="processAttrSetReflection">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.topic.topic.topic.title'">
                <xsl:message>attrSet=<xsl:value-of select="$attrSet"/></xsl:message>
                
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.topic.topic.topic.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.topic.topic.topic.topic.title'">
                <xsl:message>attrSet=<xsl:value-of select="$attrSet"/></xsl:message>
                
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.topic.topic.topic.topic.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.topic.topic.topic.topic.topic.title'">
                <xsl:message>attrSet=<xsl:value-of select="$attrSet"/></xsl:message>
                
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.topic.topic.topic.topic.topic.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
