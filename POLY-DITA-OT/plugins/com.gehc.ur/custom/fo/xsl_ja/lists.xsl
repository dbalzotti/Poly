...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="*[contains(@class, ' topic/ul ')]">
	    <xsl:choose>
		    <xsl:when test="@outputclass='checklist'">
			    <fo:list-block xsl:use-attribute-sets="ul-checklist">
    ...
    <!--GEHC. This uses the regular bullet for regular lists and the box bullet for checklists-->
        ...
        <fo:list-item xsl:use-attribute-sets="ul.li">
            <fo:list-item-label xsl:use-attribute-sets="ul.li__label">
                <fo:block xsl:use-attribute-sets="ul.li__label__content">
                    ...
                    <xsl:choose>
					    <xsl:when test="../@outputclass='checklist'">
					        <fo:inline font-size="18pt" font-weight="bold" baseline-shift="-4pt">
	...
	<!--GEHC. This applies 9pt to ol within fig or entry and 10pt elsewhere-->
	<xsl:template match="*[contains(@class, ' topic/ol ')]/*[contains(@class, ' topic/li ')]">
    <xsl:choose>
	<xsl:when test="ancestor::*[contains(@class, ' topic/entry ')]">
	    <fo:list-item xsl:use-attribute-sets="ol.li__fig">
