...
-->
    ...
    <!--GEHC. Necessary to set inside margin at 1in; added to non-printing area of page-->
	<xsl:variable name="page-margin-inside">1in</xsl:variable> <!--.875in-->
    <!--GEHC. Necessary to set outside margin at 1in; added to non-printing area of page-->
	<xsl:variable name="page-margin-outside">1in</xsl:variable> <!--.75in-->
    <xsl:variable name="page-margin-top" select="$page-margins"/>
	<!--GEHC. Added to specify top margin of first pages-->
	<xsl:variable name="page-margin-top-first">1.5in</xsl:variable>
	<xsl:variable name="page-margin-top-first-toc">1in</xsl:variable>
    ...
    <xsl:variable name="side-col-width">.75in</xsl:variable>
