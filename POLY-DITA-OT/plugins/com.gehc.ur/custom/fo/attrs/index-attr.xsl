...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0">
    ...
    <!--GEHC. Also found in index-attr_axf.xsl-->
    ...
    <xsl:attribute-set name="index.entry"> <!--FM:Level1IX, Level2IX--> <!--GEHC-->
        <xsl:attribute name="space-after">0pt</xsl:attribute>
    ...
    <xsl:attribute-set name="index-indents"> <!--GEHC-->
    ...
    <xsl:attribute-set name="index.entry__content"> <!--GEHC-->
