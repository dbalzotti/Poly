...
<!-- Header -->
  ...
  <xsl:attribute-set name="header_classification"> 
  ...
  <xsl:attribute-set name="titleHeaderEven">
  ...
  <xsl:attribute-set name="titleHeaderOdd"> 
    <xsl:attribute name="end-indent">0pt</xsl:attribute>
    <xsl:attribute name="space-before">0pt</xsl:attribute>
    <xsl:attribute name="space-before.conditionality">retain</xsl:attribute>
	<xsl:attribute name="text-align">right</xsl:attribute>
  ...
  <xsl:attribute-set name="pagenum">
	...
	<xsl:attribute-set name="__index__odd__footer__machine">
	    <xsl:attribute name="font-size">8pt</xsl:attribute>
    </xsl:attribute-set>
	...
	<xsl:attribute-set name="__index__even__footer__machine">
	    <xsl:attribute name="font-size">8pt</xsl:attribute>
    </xsl:attribute-set>
    ...
    <!--GEHC. Edited-->
	<xsl:attribute-set name="__chapter__frontmatter__name__container"> <!--FM:Section-->
		...
		<xsl:attribute name="margin-bottom">2.5in</xsl:attribute>
		<xsl:attribute name="font-family">sans-serif</xsl:attribute>
    </xsl:attribute-set>
	...
	<xsl:attribute-set name="__chapter__frontmatter__title"> 
    </xsl:attribute-set>
