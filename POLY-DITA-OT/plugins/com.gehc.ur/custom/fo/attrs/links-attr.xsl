...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0">
    ...
    <xsl:attribute-set name="link__content" use-attribute-sets="common.link"> <!--GEHC-->
    ...
    <xsl:attribute-set name="xref" use-attribute-sets="common.link"> <!--GEHC-->
	    <xsl:attribute name="color">#000000</xsl:attribute>
        <xsl:attribute name="font-style">italic</xsl:attribute>
    </xsl:attribute-set>
	
	<xsl:attribute-set name="xref__section"> <!--GEHC. Formats links in mini-TOC-->
        <xsl:attribute name="color">#000000</xsl:attribute>
