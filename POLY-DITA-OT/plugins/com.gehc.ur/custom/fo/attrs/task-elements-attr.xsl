...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--Ordered steps-->
    <xsl:attribute-set name="steps" use-attribute-sets="ol"> <!--FM:Numbered, Numbered1--> <!--GEHC-->
        <xsl:attribute name="space-after">5pt</xsl:attribute>
        <xsl:attribute name="space-before">0pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="steps.step" use-attribute-sets="ol.li"> <!--FM:Numbered, Numbered1--> <!--GEHC-->
        <xsl:attribute name="space-after">3pt</xsl:attribute>
        <xsl:attribute name="space-before">3pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="steps.step__label" use-attribute-sets="ol.li__label"> <!--FM:Numbered, Numbered1--> <!--GEHC-->
        <xsl:attribute name="space-after">0pt</xsl:attribute>
        <xsl:attribute name="space-before">0pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="steps.step__label__content" use-attribute-sets="ol.li__label__content"> <!--FM:Numbered, Numbered1--> <!--GEHC-->
    </xsl:attribute-set>
